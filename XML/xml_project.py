...
with open("dict_export_sutime.jpg", "r") as fd:
...
xml_doc = ET.Element('TimeML',  schemaLocation = 'file://C://environment//workspace//TILN')
...
# DOCTYPE tag
DOCTYPE = ET.SubElement(xml_doc,'DOCTYPE',SOURCE='extract.txt').text = 'Batalii istorice'
